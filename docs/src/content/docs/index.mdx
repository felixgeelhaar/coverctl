...
template: splash
hero:
  tagline: Stop chasing a single coverage number. Enforce coverage policies where it matters most - at the domain level.
  image:
...
<CardGrid>
  ...
  <Card title="Multiple Outputs" icon="document">
    Text, JSON, or HTML reports. Coverage badges for READMEs. Trend analysis included.
  </Card>
</CardGrid>
