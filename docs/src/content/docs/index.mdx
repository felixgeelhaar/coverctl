...
template: splash
hero:
  tagline: Stop chasing a single coverage number. Enforce coverage policies where it matters most - at the domain level. Works with 15 languages including Go, Python, TypeScript, Rust, Java, C#, C/C++, and more.
  image:
