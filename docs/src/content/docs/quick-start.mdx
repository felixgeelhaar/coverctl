...
- A project with tests (Go, Python, JavaScript, Rust, or Java)
- For Go projects: Go 1.25 or later installed
- coverctl installed ([Installation Guide](/coverctl/installation/))

:::note[Language Auto-Detection]
coverctl automatically detects your project language based on configuration files like `go.mod`, `pyproject.toml`, `package.json`, `Cargo.toml`, or `pom.xml`.
:::
